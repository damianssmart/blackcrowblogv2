<?php get_header();
/*
Template name: Projects 2-col Template
*/
?>
<?php if(have_posts()) : ?>
...
<div id="container" class="clearfix">
	<div class="container post-wrap">
		...
		<div id="content" class="span12">
			<div class="post project-temp2" id="post-<?php the_ID(); ?>" >
				<!-- Project Wrap -->
				<div class="project_wrap clearfix">
					...
					<?php if($skt_port_filter_hide == "true") { ?>
						...
						<?php } ?>
						<div id="container-isotop" class="portfolio group two-col">
							<?php 
							// The Loop
							...
							?>
							<!-- Project Box -->
							<div class="item project_box span6 <?php echo $data_type;$data_type =null; ?>" data-type="<?php echo $data_type;$data_type =null; ?>" data-id="id-<?php echo $data_id; ?>">
								<!-- standard -->
								<div class="project-item" id="post-<?php the_ID(); ?>">
									<?php if(has_post_thumbnail()) {
									$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'invert_portfolio_two_image' );
									...
									<div class="title"><a href="<?php the_permalink();?>" title="<?php the_title();?>">
									  <?php the_title();?>
									  </a>
									</div>
									<?php } ?>
