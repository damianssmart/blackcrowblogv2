...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		global $invert_shortname;
		$of_page = add_theme_page( ucwords($invert_shortname).__(' Options', 'invert'), ucwords($invert_shortname).__(' Options', 'invert'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
?>
    ...
    <?php screen_icon( 'themes' ); ?><h2><?php _e('Theme Options ','invert');?><?php echo $invert_themename;?></h2>  
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			<form action="options.php" method="post">
				...
				<input type="submit" id="invert_submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'invert' ); ?>" />
			</form>
		</div> <!-- / #container -->
	</div>
