...
class invert_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . home_url() . '/">' . __('Home', 'invert') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'invert') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'invert') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'invert');

        }

		if (is_404()) {            return __('Error 404', 'invert');        }
...
$invert_breadcumb = new invert_breadcrumb_class();
